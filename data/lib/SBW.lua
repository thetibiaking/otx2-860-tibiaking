...
SBW_AREA = {{x = 32030, y = 32194, z = 7}, {x = 32077, y = 32193, z = 7}}-- AREA DO EVENTO | Canto superior esquerdo / inferior direito
SBW_WAITROOM = {{x = 32051, y = 32197, z = 6}, {x = 32057, y = 32197, z = 6}} -- AREA DE ESPERA | Canto superior esquerdo / inferior direito
SBW_TP = {x = 32360, y = 32239, z = 7} -- local onde teleport sera criado (entrada de jogadores)
SBW_TPGO = {x = 32054, y = 32197, z = 6} -- local onde teleport vai levar (saida de jogadores)
SBW_TPEND = {x = 32369, y = 32241, z = 7} -- local onde serao teleport ao final do evento
SBW_GERADOR = {x = 32054, y = 32197, z = 7} -- local onde gerador vai ficar
...
SBW_MINAMMO = 999 -- munição inicial dos jogadores
