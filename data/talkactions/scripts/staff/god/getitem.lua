...
local coisas = db.getResult("SELECT `player_id` FROM `tibera-world`.`player_items` WHERE `itemtype` = '".. param .."';")
if (coisas:getID() ~= -1) then
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_RED, "Lista de players que possuem o item ID: ".. param .." (".. getItemNameById(param) ..").")
