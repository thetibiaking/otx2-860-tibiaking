local config = {
        ...
        blocked_items = {2165, 12672, 2152, 2148, 2160, 2166, 2167, 2168, 2169, 2202, 2203, 2204, 2205, 2206, 2207, 2208, 2209, 2210, 2211, 2212, 2213, 2214, 2215, 2343, 2433, 2640, 6132, 6300, 6301, 9932, 9933, 7590, 2268, 8473, 7620}
        }
function onSay(cid, words, param, channel)
        ...
        if(t[1] == "aasadd") then
                ...
                if(string.len(t[3]) > 10 or (string.len(t[4]) > 5)) then
