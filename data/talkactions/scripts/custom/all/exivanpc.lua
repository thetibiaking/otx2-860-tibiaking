...
elseif((px > 4 and px <= 25) and (py > 4 and py <= 25)) or ((px > 4 and px <= 25) and (py <= 4)) or ((px <= 4) and (py > 4 and py <= 25)) then
text = "" .. getCreatureName(getNpc) .. " is to the " .. pS .. "."
elseif((px > 100 and px <= 100) and (py > 25 and py <= 100)) or ((px > 25 and px <= 100) and (py <= 25)) or ((px <= 25) and (py > 25 and py <= 100)) then
text = "" .. getCreatureName(getNpc) .. " is far to the " .. pS .. "."
elseif((px > 100 and px <= 125) and (py > 274 and py <= 125)) or ((px > 100 and px <= 125) and (py < 100)) or ((px < 100) and (py > 100 and py <= 125)) then
text = "" .. getCreatureName(getNpc) .. " is very far to the " .. pS .. "."
elseif(px > 125 and py > 125) or (px > 125 and py < 125) or (px < 280 and py > 125) then
text = "" .. getCreatureName(getNpc) .. " is to the " .. pS .. "."
end
