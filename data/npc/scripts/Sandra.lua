...
npcHandler:say('Do you want to buy the winning lottery ticket?', cid)
...
if getPlayerItemCount(cid, 2160) >= 65 then

if doPlayerRemoveItem(cid, 2160, 65) then
...
npcHandler:say('Sorry I need 65 Crystal Coins from you for a lottery ticket.', cid)
...
shopModule:addBuyableItem({'empty potion flask'}, 7636, 1000, 1, 'empty potion flask')
