...
local travelNode = keywordHandler:addKeyword({'boss room'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you seek a passage to boss room for 0 gold?'})
        	travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 0, destination = {x=32317, y=32469, z=7} })
        	travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'We would like to serve you some time.'})
        

        
        keywordHandler:addKeyword({'kill boss'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Você quer ir para sala de boss? Então diga-me {boss room}.'})
        keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Você quer ir para sala de boss?'})
		keywordHandler:addKeyword({'Grizzly Adams'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I am the captain of this ship.'})
