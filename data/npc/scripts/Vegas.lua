...
local function rollDice(roll, cc_count, pc_count, table_left_pos, table_middle_pos, npc)
        ...
        if ((total_g) <= 500000 and (total_g) >= 5000) then
                ...
                doCreatureSay(npc, "The minimum wager is 5K and the maximum wager is 500K.", TALKTYPE_SAY, false, 0)
        end
        return true
end
...
function creatureSayCallback(cid, type, msg)
        ...
        local table_left_pos = {x = 32354, y = 32225, z = 7} -- Pos da frente do Npc onde gira o dado
        local table_middle_pos = {x = 32353, y = 32225, z = 7} -- Pos do meio onde vai o dinheiro
        ...
        posplayer = {x=32352, y=32226, z=7} -- Pos onde o player precisa estar
