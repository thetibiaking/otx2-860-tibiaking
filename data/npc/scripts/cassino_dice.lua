...
local function rollDice(roll, cc_count, pc_count, table_left_pos, table_middle_pos, npc)
	...
	if ((total_g) <= 1000000 and (total_g) >= 5000) then
		...
		doCreatureSay(npc, "The minimum wager is 5K and the maximum wager is 1KK.", TALKTYPE_SAY, false, 0)
	end
	return true
end
...
function creatureSayCallback(cid, type, msg)
	...
	local table_left_pos = {x = 32352, y = 32225, z = 7}
	local table_middle_pos = {x = 32353, y = 32225, z = 7}
