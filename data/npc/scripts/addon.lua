...
function MageFirst(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,2182) >= 1 and 
			getPlayerItemCount(cid,2186) >= 1 and
			getPlayerItemCount(cid,2185) >= 1 and
			getPlayerItemCount(cid,8911) >= 1 and
			getPlayerItemCount(cid,2181) >= 1 and
			getPlayerItemCount(cid,2183) >= 1 and
			getPlayerItemCount(cid,2190) >= 1 and
			getPlayerItemCount(cid,2191) >= 1 and
			getPlayerItemCount(cid,2188) >= 1 and
			getPlayerItemCount(cid,8921) >= 1 and
			getPlayerItemCount(cid,2189) >= 1 and
			getPlayerItemCount(cid,2187) >= 1 and
			getPlayerItemCount(cid,5904) >= 10 and
			getPlayerItemCount(cid,5809) >= 1 and
			getPlayerItemCount(cid,2193) >= 20 then
			
        if doPlayerRemoveItem(cid,2182,1) and
			doPlayerRemoveItem(cid,2186,1) and
			doPlayerRemoveItem(cid,2185,1) and
			doPlayerRemoveItem(cid,8911,1) and
			doPlayerRemoveItem(cid,2181,1) and
			doPlayerRemoveItem(cid,2183,1) and
			doPlayerRemoveItem(cid,2190,1) and
			doPlayerRemoveItem(cid,2191,1) and
			doPlayerRemoveItem(cid,2188,1) and
			doPlayerRemoveItem(cid,8921,1) and
			doPlayerRemoveItem(cid,2189,1) and
			doPlayerRemoveItem(cid,2187,1) and
			doPlayerRemoveItem(cid,5904,10) and
			doPlayerRemoveItem(cid,5809,1) and
			doPlayerRemoveItem(cid,2193,20) then
            selfSay(newaddon, cid)
   ...
   if isPremium(cid) then
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5894) >= 70 and
			getPlayerItemCount(cid,5911) >= 20 and
			getPlayerItemCount(cid,5922) >= 35 and
			getPlayerItemCount(cid,5886) >= 10 and
			getPlayerItemCount(cid,5881) >= 60 and
			getPlayerItemCount(cid,5882) >= 40 and
			getPlayerItemCount(cid,5883) >= 40 and
			getPlayerItemCount(cid,5904) >= 15 and
			getPlayerItemCount(cid,5905) >= 30 then
			
        if doPlayerRemoveItem(cid,5894,70) and
			doPlayerRemoveItem(cid,5911,20) and
			doPlayerRemoveItem(cid,5922,35) and
			doPlayerRemoveItem(cid,5886,10) and
			doPlayerRemoveItem(cid,5881,60) and
			doPlayerRemoveItem(cid,5882,40) and
			doPlayerRemoveItem(cid,5883,40) and
			doPlayerRemoveItem(cid,5904,15) and
			doPlayerRemoveItem(cid,5905,30) then
            selfSay(newaddon, cid)
...
function BarbarianSecond(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5884) >= 1 and getPlayerItemCount(cid,5885) >= 1 and getPlayerItemCount(cid,5910) >= 50 and getPlayerItemCount(cid,5911) >= 50 and getPlayerItemCount(cid,5886) >= 10 and getPlayerStorageValue(cid,barbarian) then
        if doPlayerRemoveItem(cid,5884,1) and doPlayerRemoveItem(cid,5885,1) and doPlayerRemoveItem(cid,5910,50) and doPlayerRemoveItem(cid,5911,50) and doPlayerRemoveItem(cid,5886,10) then
            selfSay(newaddon, cid)
...
function DruidSecond(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5906) >= 100 and getPlayerItemCount(cid,9971) >= 2 and getPlayerItemCount(cid,5940) >= 1 then
        if doPlayerRemoveItem(cid,5906,100) and doPlayerRemoveItem(cid,9971,2) and doPlayerRemoveItem(cid,5940,1) then
            selfSay(newaddon, cid)
...
function AssassinFirst(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
		...
		getPlayerItemCount(cid,5914) >= 50 and
		getPlayerItemCount(cid,5913) >= 50 and
		getPlayerItemCount(cid,5911) >= 50 and
		getPlayerItemCount(cid,5910) >= 50 and
		getPlayerItemCount(cid,5912) >= 50 and
		getPlayerItemCount(cid,5886) >= 10 then
        if doPlayerRemoveItem(cid,5909,50) and
		doPlayerRemoveItem(cid,5914,50) and
		doPlayerRemoveItem(cid,5913,50) and
		doPlayerRemoveItem(cid,5911,50) and
		doPlayerRemoveItem(cid,5910,50) and 		
		doPlayerRemoveItem(cid,5912,50) and
		doPlayerRemoveItem(cid,5886,10) then
            selfSay(newaddon, cid)
...
function AssassinSecond(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5930) >= 10 and 
			getPlayerItemCount(cid,5804) >= 1 then
        if doPlayerRemoveItem(cid,5930,10) and
			doPlayerRemoveItem(cid,5804,1) then
            selfSay(newaddon, cid)
...
function BeggarFirst(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5894) >= 10 and
			getPlayerItemCount(cid,5913) >= 20 and
			getPlayerItemCount(cid,5921) >= 30 then
        if doPlayerRemoveItem(cid,5894,10) and
			doPlayerRemoveItem(cid,5913,20) and
			doPlayerRemoveItem(cid,5921,30) then
            selfSay(newaddon, cid)
...
function BeggarSecond(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5883) >= 100 and
			getPlayerItemCount(cid,2160) >= 2 and
			getPlayerItemCount(cid,6107) >= 1 then
        if doPlayerRemoveItem(cid,6107,1) and doPlayerRemoveItem(cid,5883,1) and doPlayerRemoveItem(cid,2160,2) then
            selfSay(newaddon, cid)
...
function JesterFirst(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5912) >= 5 and
		getPlayerItemCount(cid,5913) >= 4 and
		getPlayerItemCount(cid,5914) >= 2 and
		getPlayerItemCount(cid,5909) >= 3 then
        if doPlayerRemoveItem(cid,5912,5) and
		doPlayerRemoveItem(cid,5913,4) and
		doPlayerRemoveItem(cid,5909,3) and
		doPlayerRemoveItem(cid,5914,2) then
            selfSay(newaddon, cid)
...
function JesterSecond(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,5910) >= 3 and getPlayerItemCount(cid,5911) >= 3 and getPlayerItemCount(cid,5912) >= 5 then
        if doPlayerRemoveItem(cid,5910,3) and doPlayerRemoveItem(cid,5911,3) and doPlayerRemoveItem(cid,5912,5) then
            selfSay(newaddon, cid)
...
function WarmasterFirst(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,11116) then
...
function WarmasterSecond(cid, message, keywords, parameters, node)
    ...
    if addon == -1 then
        if getPlayerItemCount(cid,11115) >= 1 then
...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "What you do is that you type 'first hunter addon' or 'second hunter addon' where you replace 'hunter' with whatever outfit you'd like to achieve the addons for. Assuming that you already collected all the required pieces, say 'yes' and voíla - you got yourself an addon!"})
 ...
 node5 = keywordHandler:addKeyword({'first mage addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first mage addon you need to give me all kind of wands and rods, 10 magic sulphurs, 20 ankhs and a soul stone. Do you have it with you?'})
 ...
 node6 = keywordHandler:addKeyword({'second mage addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second mage addon you need to give me a ferumbras\' hat. Do you have them with you?'})
 ...
 node11 = keywordHandler:addKeyword({'first summoner addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first summoner addon you need to give me a winning lottery ticket. Do you have it with you?'})
 ...
 node15 = keywordHandler:addKeyword({'first barbarian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first barbarian addon you need to give me a 100 Iron Ore, 1 Huge Chunk of Crude Iron, 50 Perfect Behemoth Fang and 50 Lizard Leather. Do you have them with you?'})
 ...
 node16 = keywordHandler:addKeyword({'second barbarian addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second barbarian addon you need to give me 01 Spirit Container, 01 Flask of Warriors Sweat , 50 Green Piece of Cloth , 50 Red Piece of Cloth and 10 Spool of Yarn . Do you have them with you?'})
 ...
 node18 = keywordHandler:addKeyword({'second druid addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second druid addon you need to give me a 100 demon dusts, 2 gold ingots and Ceirons wolf tooth chain. Do you have them with you?'})
 ...
 node19 = keywordHandler:addKeyword({'first wizard addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first wizard addon you need to give me a 50 holy orchids. Do you have them with you?'})
 ...
 node20 = keywordHandler:addKeyword({'second wizard addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second wizard addon you need to give me a dragon scale mail, a pair of crown legs, a medusa shield and a ring of the sky. Do you have them with you?'})
 ...
 node26 = keywordHandler:addKeyword({'second assassin addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second assassin addon you need to give me a 1 nose ring and 10 behemoth claw. Do you have them with you?'})
 ...
 node27 = keywordHandler:addKeyword({'first beggar addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first beggar addon you need to give me 50 minotaur leather, 30 heaven blossom, 20 brown piece of cloth and 10 batwing. Do you have them with you?'})
 ...
 node28 = keywordHandler:addKeyword({'second beggar addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second beggar addon you need to give me 100 apper fur, 02 crystal coins and simon the beggar\'s staff. Do you have it with you?'})
 ...
 node29 = keywordHandler:addKeyword({'second shaman addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first shaman addon you need to give me 5 pirate voodoo doll, 5 voodoo doll and 1 mandrake. Do you have them with you?'})
 ...
 node35 = keywordHandler:addKeyword({'first jester addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first jester addon you need to give me a 5 blue piece of cloth, 4 brown piece of cloth, 3 white piece of cloth and 2 yellow pice of cloth. Do you have them with you?'})
 ...
 node36 = keywordHandler:addKeyword({'second jester addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second jester addon you need to give me 3 green piece of cloth, 3 red piece of cloth and 5 blue piece of cloth. Do you have them with you?'})
 ...
 node41 = keywordHandler:addKeyword({'first warmaster addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first warmaster addon you need to give me a 1 tribal crest. Do you have them with you?'})
    node41:addChildKeyword({'yes'}, WarmasterFirst, {})
 ...
 node42 = keywordHandler:addKeyword({'second warmaster addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first warmaster addon you need to give me a 1 serpent crest. Do you have them with you?'})
    node42:addChildKeyword({'yes'}, WarmasterSecond, {})
