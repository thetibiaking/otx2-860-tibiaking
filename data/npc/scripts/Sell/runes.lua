...
shopModule:addBuyableItem({'energy bomb'}, 2262, 200, 1, 'energy bomb rune')
...
shopModule:addBuyableItem({'energy field'}, 2277, 10,  1, 'energy field rune')
...
shopModule:addBuyableItem({'ultimate healing'}, 2273, 60, 1, 'ultimate healing rune')
shopModule:addBuyableItem({'chameleon'}, 2291, 210, 1, 'chameleon rune')
