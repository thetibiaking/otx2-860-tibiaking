...
shopModule:addBuyableItem({'great spirit'}, 8472, 180, 1, 'great spirit potion')
shopModule:addBuyableItem({'ultimate health'}, 8473, 280, 1, 'ultimate health potion')
...
shopModule:addBuyableItem({'wild growth'}, 2269, 350, 10, 'wild growth rune')
...
shopModule:addBuyableItem({'explosion'}, 2313, 250, 15, 'explosion rune')
shopModule:addBuyableItem({'sudden death'}, 2268, 80, 1, 'sudden death rune')
shopModule:addBuyableItem({'paralyze'}, 2278, 600, 5, 'paralyze rune')
