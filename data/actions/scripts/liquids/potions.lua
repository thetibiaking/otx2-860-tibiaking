...
local POTIONS = {
	...
	[8473] = {empty = 7635, health = {750, 900}, level = 130, vocations = {4, 8}, vocStr = "knights"}, -- ultimate health potion

	[7620] = {empty = 7636, mana = {100, 130}}, -- mana potion
	[7589] = {empty = 7634, mana = {150, 300}, level = 50, vocations = {1, 2, 3, 5, 6, 7}, vocStr = "sorcerers, druids and paladins"}, -- strong mana potion
	[7590] = {empty = 7635, mana = {220, 350}, level = 80, vocations = {1, 2, 5, 6}, vocStr = "sorcerers and druids"}, -- great mana potion

	[8472] = {empty = 7635, health = {300, 400}, mana = {190, 250}, level = 80, vocations = {3, 7}, vocStr = "paladins"} -- great spirit potion
}
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if getPlayerStorageValue(cid,823550) >= os.time() or hasCondition(cid, CONDITION_EXHAUST) then
	...
	doRemoveItem(item.uid, 1)
	doPlayerSetStorageValue(cid, 823561, os.time() + 1.0)
