local config = {
	...
	rocks = {
		{x = 33219, y = 31657, z = 13, stackpos = 255},
		{x = 33221, y = 31657, z = 13, stackpos = 255},
		{x = 33219, y = 31659, z = 13, stackpos = 255},
		{x = 33220, y = 31659, z = 13, stackpos = 255},
		{x = 33221, y = 31659, z = 13, stackpos = 255},
		{x = 33222, y = 31659, z = 13, stackpos = 255},
		{x = 33223, y = 31659, z = 13, stackpos = 255},
		{x = 33224, y = 31659, z = 13, stackpos = 255},
		{x = 33220, y = 31661, z = 13, stackpos = 255},
		{x = 33222, y = 31661, z = 13, stackpos = 255}
	},
	demons = {
...
local function areaCheck(area)
	...
	for x = config.room[1].x, config.room[2].x do
		for y = config.room[1].y, config.room[2].y do
			local t = getThingFromPos({x=x, y=y, z=config.room[1].z, stackpos=255})
			if t.uid > 0 then
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	for _, pos in ipairs(config.demons) do
		doCreateMonster("Demon", pos, false, true) --TFS 0.3.6 -> [ doCreateMonster("Demon", pos) ]
