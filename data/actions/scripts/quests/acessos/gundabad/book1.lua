function onUse(cid, item, fromPosition, itemEx, toPosition)
        if(item.actionid == 58750 and getPlayerStorageValue(cid, 58750) == 5 and getPlayerStorageValue(cid, 58751) == -1) then
				setPlayerStorageValue(cid, 58751, 1)
				doCreatureSay(cid, "Um livro encontrado.", TALKTYPE_ORANGE_1)
				elseif getPlayerStorageValue(cid, 58751) >= 1 then
