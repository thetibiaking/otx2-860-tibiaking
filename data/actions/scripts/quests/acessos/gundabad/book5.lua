function onUse(cid, item, fromPosition, itemEx, toPosition)
        if(item.actionid == 58754 and getPlayerStorageValue(cid, 58750) == 5 and getPlayerStorageValue(cid, 58751) == 4) then
				setPlayerStorageValue(cid, 58751, 5)
				setPlayerStorageValue(cid, 58750, 6)
				doCreatureSay(cid, "Um livro encontrado.", TALKTYPE_ORANGE_1)
				elseif getPlayerStorageValue(cid, 58751) >= 5 then
