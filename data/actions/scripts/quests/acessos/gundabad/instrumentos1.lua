function onUse(cid, item, fromPosition, itemEx, toPosition)
        if(item.actionid == 58760 and getPlayerStorageValue(cid, 58750) == 8 and getPlayerStorageValue(cid, 58761) == -1) then
				setPlayerStorageValue(cid, 58761, 1)
				doCreatureSay(cid, "Um livro encontrado.", TALKTYPE_ORANGE_1)
				elseif getPlayerStorageValue(cid, 58761) >= 1 then
