...
local thaiss = {x=32513, y=32531, z=7}
    ...
    if item.actionid == 16360 and getPlayerStorageValue (cid, 75320) == 1 and getPlayerStorageValue (cid, 17672) == -1 then 
		...
		doPlayerSetStorageValue (cid, 17672, 1)
		doSummonCreature(config.boss, config.bosspos[1])
		elseif getPlayerStorageValue (cid, 75320) == -1 then
