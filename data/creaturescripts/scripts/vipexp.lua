...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Você tem "..((1.30 - 1)*100).."% de exp a mais agora! (VIP ACCOUNT + WAR OF EMPERIUM).")
elseif vip.hasVip(cid) and Guild_ID ~= infoLua[2] then
doPlayerSetExperienceRate(cid, 1.15)
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Você tem "..((1.15 - 1)*100).."% de exp a mais agora! (VIP ACCOUNT).")
elseif (not vip.hasVip(cid)) and Guild_ID == infoLua[2] then
doPlayerSetExperienceRate(cid, 1.15)
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Você tem "..((1.15 - 1)*100).."% de exp a mais agora! (WAR OF EMPERIUM).")
else
