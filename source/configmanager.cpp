...
bool ConfigManager::load()
{
	...
	m_confNumber[RED_GUILD_LIMIT] = getGlobalNumber("guildFragsToRedSkull", m_confNumber[RED_LIMIT]);
	m_confNumber[RED_SECOND_GUILD_LIMIT] = getGlobalNumber("guildFragsSecondToRedSkull", m_confNumber[RED_SECOND_LIMIT]);
	m_confNumber[RED_THIRD_GUILD_LIMIT] = getGlobalNumber("guildFragsThirdToRedSkull", m_confNumber[RED_THIRD_LIMIT]);
	...
	m_confNumber[CAST_BONUS_EXP] = getGlobalNumber("castBonusExpPercent", 0);
	m_confNumber[CLIENT_BONUS_EXP] = getGlobalNumber("clientBonusExpPercent", 0);
