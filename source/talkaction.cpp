...
bool TalkAction::loadFunction(const std::string& functionName)
{
	...
	else if(m_functionName == "showloot")
		m_function = showLoot;
...
bool TalkAction::showLoot(Creature* creature, const std::string&, const std::string& param)
{
	Player* player = creature->getPlayer();
	...
	player->sendChannelMessage("", channel, MSG_CHANNEL, CHANNEL_LOOT);
