...
ItemType::ItemType()
{
	...
	date = 0;
	writeOnceItemId = wareId = premiumDays = newClientId = 0;
...
int32_t Items::loadFromOtb(std::string file)
{
	...
	for(node = f.getChildNode(node, type); node != NO_NODE; node = f.getNextNode(node, type))
	{
		...
		if(iType->clientId && !iType->newClientId) {
			if (reverseItemMap.find(iType->clientId) == reverseItemMap.end())
				reverseItemMap[iType->clientId] = iType->id;
		}
		else if (iType->newClientId)
			reverseItemMap[iType->newClientId] = iType->id;
	}
...
void Items::parseItemNode(xmlNodePtr itemNode, uint32_t id)
{
	...
	for(xmlNodePtr itemAttributesNode = itemNode->children; itemAttributesNode; itemAttributesNode = itemAttributesNode->next)
	{
		...
		else if(tmpStrValue == "newclientid")
		{
			if(readXMLInteger(itemAttributesNode, "value", intValue))
				it.newClientId = intValue;
		}
		else
...
const ItemType& Items::getItemIdByClientId(int32_t spriteId) const
{
	...
	if(spriteId == 16901) // exercise axe
		return getItemType(12250);
	else if (spriteId == 16903) // exercise bow
		return getItemType(9662);
	else if (spriteId == 16902) // exercise club
		return getItemType(8306); 
	else if (spriteId == 16900) // exercise sword
		return getItemType(8305);
	else if (spriteId == 16904) // exercise rod
		return getItemType(8300);
	else if (spriteId == 16905) // exercise wand
		return getItemType(8304);
	else if (spriteId == 15696) // gnomish extraction crystal
		return getItemType(18213);
	else if (spriteId == 15802) // gnomish crystal package
		return getItemType(18313);
	else if (spriteId == 15832) // bell
		return getItemType(18343);
	else if (spriteId == 15703) // gnomish repair crystal
		return getItemType(2437);
	else if (spriteId == 15817) // gnomish spore gatherer
		return getItemType(18328);
	else if (spriteId == 15828) // little pig
		return getItemType(18339);
	else if (spriteId == 16167) // teleport crystalnewtibia.com/2wgh2CN3
		return getItemType(18457);
	else if (spriteId == 16121) // green crystal shard/
		return getItemType(18415);
	else if (spriteId == 16119) // blue crystal shard
		return getItemType(18413);
	else if (spriteId == 16120) // violet crystal shard
		return getItemType(18414);
	else if (spriteId == 16126) // red crystal fragment
		return getItemType(18420);
	else if (spriteId == 16127) // green crystal fragment
		return getItemType(18421);
	else if (spriteId == 16125) // cyan crystal fragment
		return getItemType(18419);
	else if (spriteId == 16123) // brown crystal splinter
		return getItemType(18417);
	else if (spriteId == 16124) // blue crystal splinter
		return getItemType(18418);
	else if (spriteId == 16122) // green crystal splinter
		return getItemType(18416);
	else if (spriteId == 16103) // mushroom pie
		return getItemType(18397);
	else if (spriteId == 16103) // mushroom pie
		return getItemType(18397);
	else if (spriteId == 15793) // crystalline arrow
		return getItemType(18304);
	else if (spriteId == 16142) // drill bolt
		return getItemType(18436);
	else if (spriteId == 16141) // prismatic bolt
		return getItemType(18435);
	else if (spriteId == 16143) // envenomed arrow
		return getItemType(18437);
	else if (spriteId == 20198) // fazzle tongue
		return getItemType(22532);
	else if (spriteId == 20199) // fazzle skin
		return getItemType(22533);
	else if (spriteId == 15793) // crystalline arrow
    	return getItemType(18304);
	else if (spriteId == 16142) // drill bolt
	    return getItemType(18436);
	    ...
	    return getItemType(22533);
	else if (spriteId == 14252) // Vortex Bolt
	    return getItemType(15649);
	else if (spriteId == 14251) // Tarsal Arrow
	    return getItemType(15648);
	else if (spriteId == 14086) // calopteryx cape
	    return getItemType(15489);
	else if (spriteId == 14088) // carapace shield
	    return getItemType(15491);
	else if (spriteId == 13991) // Deepling Axe
	    return getItemType(15404);
	else if (spriteId == 14250) // Deepling Squelcher
	    return getItemType(15647);
	else if (spriteId == 13987) // Deepling Staff
	    return getItemType(15400);
	else if (spriteId == 13997) // Depth Calcei
	    return getItemType(15410);
	else if (spriteId == 13995) // Depth Galea
	    return getItemType(15408);
	else if (spriteId == 13994) // Depth Lorica
	    return getItemType(15407);
	else if (spriteId == 13996) // Depth Ocrea
	    return getItemType(15409);
	else if (spriteId == 13998) // Depth Scutum
	    return getItemType(15411);
	else if (spriteId == 14087) // Grasshopper Legs
	    return getItemType(15490);
	else if (spriteId == 14246) // Hive Bow
	    return getItemType(15643);
	else if (spriteId == 14089) // Hive Scythe
	    return getItemType(15492);
	else if (spriteId == 13990) // Necklace of the Deep
	    return getItemType(15403);
	else if (spriteId == 13993) // Ornate Chestplate
	    return getItemType(15406);
	else if (spriteId == 14247) // Ornate Crossbow
	    return getItemType(15644);
	else if (spriteId == 13999) // Ornate Legs
	    return getItemType(15412);
	else if (spriteId == 14001) // Ornate Mace
	    return getItemType(15414);
	else if (spriteId == 14000) // Ornate Shield
	    return getItemType(15413);
	else if (spriteId == 14040) // Warriors Axe
	    return getItemType(15451);
	else if (spriteId == 14042) // Warriors Shield
	    return getItemType(15453);
	else if (spriteId == 14083) // Compound Eye
	    return getItemType(15486);
	else if (spriteId == 14079) // Crawler Head Plating
	    return getItemType(15482);
	else if (spriteId == 14011) // Deepling Breaktime Snack
	    return getItemType(15424);
	else if (spriteId == 14044) // Deepling Claw
	    return getItemType(15455);
	else if (spriteId == 14010) // Deepling Guard Belt Buckle
	    return getItemType(15423);
	else if (spriteId == 14041) // Deepling Ridge
	    return getItemType(15452);
	else if (spriteId == 14017) // Deepling Scales
	    return getItemType(15430);
	else if (spriteId == 14012) // Deepling Warts
	    return getItemType(15425);
	else if (spriteId == 14013) // Deeptags
	    return getItemType(15426);
	else if (spriteId == 14009) // Key to the Drowned Library
	    return getItemType(15422);
	else if (spriteId == 14077) // Kollos Shell
	    return getItemType(15480);
	else if (spriteId == 14008) // Spellsingers Seal
	    return getItemType(15421);
	else if (spriteId == 14082) // Spidris Mandible
	    return getItemType(15485);
	else if (spriteId == 14078) // Spitter Nose
	    return getItemType(15481);
	else if (spriteId == 14076) // Swarmer Antenna
	    return getItemType(15479);
	else if (spriteId == 14080) // Waspoid Claw
	    return getItemType(15483);
	else if (spriteId == 14081) // Waspoid Wing
	    return getItemType(15484);
