...
void Monster::onThinkYell(uint32_t interval)
{
	...
	if(vb.yellText)
		g_game.internalCreatureSay(this, MSG_SPEAK_MONSTER_YELL, vb.text, false, NULL, NULL, 0, false);
	else
		g_game.internalCreatureSay(this, MSG_SPEAK_MONSTER_SAY, vb.text, false, NULL, NULL, 0, false);
}
